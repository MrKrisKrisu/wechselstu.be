  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex flex-col gap-4 p-4">
      ...
      <div class="mb-4 flex items-center gap-2">
        ...
        <button class="ml-2 rounded bg-green-500 px-3 py-1 text-white hover:bg-green-600" @click="() => fetchTasks()">
          Apply
        </button>
      </div>
      ...
      <div class="overflow-x-auto rounded-lg shadow">
        <table class="min-w-full divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap dark:text-gray-200">{{ task.register }}</td>
