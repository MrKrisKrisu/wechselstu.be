...
const navItems = [
    ...
    { name: 'Monitor-Zugang', to: '/finance/dashboard-access', icon: MonitorIcon, exact: false },
];
    ...
    <div class="flex h-screen overflow-hidden bg-slate-50">
        ...
        >
            <div class="flex h-16 items-center justify-between border-b border-slate-800 px-6">
                <span class="text-lg font-semibold tracking-tight text-white">wechselstu.be</span>
                <button
        ...
        <div class="flex flex-1 flex-col overflow-hidden">
            <header class="flex h-16 items-center gap-4 border-b border-slate-200 bg-white px-4 lg:hidden">
                ...
                <span class="text-base font-semibold text-slate-900">wechselstu.be</span>
            </header>
