...
class WorkOrderApiTest extends TestCase {
    ...
    public function public_can_create_overflow_work_order() {
        ...
        $response = $this->postJson("/api/registers/{$register->token}/work-orders", [
            'type'  => 'overflow',
    ...
    public function public_can_create_change_request_with_items() {
        ...
        $response = $this->postJson("/api/registers/{$register->token}/work-orders", $payload);
    ...
    #[Test]
    public function admin_can_get_work_order_details() {
        $user = User::factory()->create();
        Passport::actingAs($user);
    ...
    #[Test]
    public function admin_get_work_order_returns_404_for_invalid_id() {
        $user = User::factory()->create();
        Passport::actingAs($user);

        $response = $this->getJson('/api/work-orders/00000000-0000-0000-0000-000000000000');
